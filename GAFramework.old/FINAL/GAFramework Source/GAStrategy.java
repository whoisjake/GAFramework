//***********************************************
// file:   GAStrategy.java
// author: Ryan Dixon
// date:   March 10, 2002
// notes:  Multiple Strategy patterns wrapped up into
//         one in order to create a highly flexible
//         and general evolution process.
//***********************************************
// updated: PJ
// date:   March 11, 2002
// notes:  Modified for "Product Example"
//    !no longer reflected in this code
//***********************************************
// updated: Pat Burke
// date:  April 04, 2002
// notes: Added functionality of IndividualHolder
//***********************************************
// updated: Ryan Dixon
// date:  April 13, 2002
// notes: Update provides user interface for configuring variables
//***********************************************
...
/**
 * <code>GAStrategy</code> controls the process of creating new {@link GAIndividual}
 * objects and generations (taking on the Controller aspect of the MVC implementation). 
 * <br><br>Objects of this class run as independent threads; sub-classes
 * must be aware of potential syncronization problems!  <code>GAStrategy</code> contains
 * a listener that alerts all subscribed views of generation changes.
 * <br><br>This version contains the capability of running in either a graphical mode
 * or just text.
 *
 * @version 1.1
 * @since 1.0
...
public class GAStrategy implements Runnable
{
    ...
    /** Constructs a graphical-interface-based <code>GAStrategy</code> object.
     * @see #GAStrategy( FitnessFunction, GAIndividual )
     * @parameter frame The parent frame responsible for this object's instantiation
     * @parameter f The <code>FitnessFunction</code> used for this strategy's evaluations
     * @parameter foreFather The <code>GAIndividual</code> type to be generated
     * @see FitnessFunction
     * @see GAIndividual
     */
    ...
    /** Constructs a text-based <code>GAStrategy</code> object.
     * @see #GAStrategy( Frame, FitnessFunction, GAIndividual )
     * @parameter f The <code>FitnessFunction</code> used for this strategy's evaluations
     * @parameter foreFather The <code>GAIndividual</code> type to be generated
     * @see FitnessFunction
     * @see GAIndividual
    ...
    // Use for non-graphical implementation!
