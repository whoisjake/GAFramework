...
// Edited by Jake Good Sat Feb 16 2002 added: public String getExpression()
//															 removed operators not needed
...
public class MathEvaluator
{
    ...
    private void initializeOperators()
    {
        ...
        operators[5]  = new Operator("%"	, 2, 10);
		  operators[6] = new Operator("sqrt", 1, 20);
    }
	...
	{
		return "MathExpression: "+expression;
	}
	public String[] operators()
	{
		String [] ops = new String [7];
		for(int i=0; i < 7; i++)
		{
			ops[i]=operators[i].getOperator();
		}
		return ops;
	}
