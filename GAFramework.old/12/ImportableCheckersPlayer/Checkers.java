...
// --
// Updated by: Ryan Dixon
// -> Removed "Pass" Option and configured for appropriate Frame display.
// -> Included "New Player" option to select different checker player
//     personalities
//******************************************************************************
   import java.applet.*;
   import java.awt.*;
...
//==============================================================================
    public class Checkers extends Frame
   {
      ...
      Board2 board = new Board2(this);
      Button newgameButton,newPlayerButton;
   ...
   //--------------------------------------------------------------------------
       public Checkers()
      {
         ...
         c.gridx = 2;
         gridbag.setConstraints(newPlayerButton,c);
         add(newPlayerButton);
   ...
   //--------------------------------------------------------------------------
      ...
      {				  
         ...
         else if (evt.target == newPlayerButton)
         {
