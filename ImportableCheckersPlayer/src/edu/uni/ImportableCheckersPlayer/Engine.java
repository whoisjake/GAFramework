...
// author: Jake Good
// date:   March 28, 2002
// notes:  Adapted from Victor Huang and Sung Ha Huh
//         refer the system documentation
//***********************************************
// modified: Ryan Dixon
// date:     April 12, 2002
// notes:    Included user interface for importing different
//           checker player personalities.
//           Very un-java-like due to 'static' declarations
//           in previous code.
//***********************************************

import edu.uni.GAFramework.IndividualHolder;
import java.util.*;
import java.io.*;
import javax.swing.*;
...
static void initializeCheckersEvaluator()
{
    ...
    static private class CheckersPlayerSelector
    {
        ...
        static edu.uni.Checkers.CheckersEvaluator	evaluator;
        ...
        public CheckersPlayerSelector(Vector players)
        {
            ...
            playButton.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e)
                {
                    ...
                    IndividualHolder holder = (IndividualHolder)selection.getUserObject();
                    evaluator = holder.individual();
        ...
        {
            if ( evaluator != null )
                return new CheckersEvaluator(evaluator.getAttributes());
