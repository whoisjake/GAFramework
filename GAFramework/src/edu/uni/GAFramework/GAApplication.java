...
public class GAApplication extends JFrame
{
    ...
    public GAApplication()
    {
        ...
        initializeObjectMonitor("foo", "bar");
    }
    ...
    protected void initializeObjectMonitor(String fitness, String individual)
    {
        try{
            ...
            Class fitnessClass = Class.forName("edu.uni.Checkers.CheckersFitness");
            Class individualClass = Class.forName("edu.uni.Checkers.CheckersEvaluator");
